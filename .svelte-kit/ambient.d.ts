...
declare module '$env/static/private' {
	...
	export const PATH_TO_OPENSSL_INCLUDE: string;
	...
	export const PATH_TO_OPENSSL_BIN: string;
	export const ZDOTDIR: string;
	export const USER: string;
	export const DOTNET_SYSTEM_GLOBALIZATION_INVARIANT: string;
	...
	export const PATH_TO_OPENSSL_MAN: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PATH_TO_OPENSSL_INCLUDE: string;
		...
		PATH_TO_OPENSSL_BIN: string;
		ZDOTDIR: string;
		USER: string;
		DOTNET_SYSTEM_GLOBALIZATION_INVARIANT: string;
